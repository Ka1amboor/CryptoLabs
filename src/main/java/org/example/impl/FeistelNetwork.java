...
public class FeistelNetwork implements ICipher {
    ...
    protected final ICipherConversion encryptConversion;
    protected final IKeyGenerator expandKey;
    ...
    public FeistelNetwork(
            ICipherConversion encryptConversion,
            IKeyGenerator expandKey,
            int rounds) {
    ...
    @Override
    public ICipher setKey(byte[] key) {
        if (key == null) {
            throw new NullPointerException("Key cannot be null!");
        }
        this.rKeys = expandKey.generateRoundKeys(key);
        return this;
    }
